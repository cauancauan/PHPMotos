      ...
      <form method="post" action="{{route('salvar-banco')}}">
        ...
        <div class="user-details1">
          <div class="input-box">
            ...
            <input type="text" name="modelo" placeholder="Informe o modelo" required>
          </div>
          <div class="input-box">
            <span class="details1">Marca</span>
            <input type="text" name="marca" placeholder="Informe a marca" required>
          </div>
          <div class="input-box">
            <span class="details1">Ano</span>
            <input type="text" name="ano" placeholder="Informe o ano" required>
          </div>
          <div class="input-box">
            <span class="details1">Cor</span>
            <input type="text" name="cor" placeholder="Informe a cor" required>
          </div>
          <div class="input-box">
